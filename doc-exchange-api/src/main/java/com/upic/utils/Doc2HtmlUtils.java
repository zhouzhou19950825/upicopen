...
public class Doc2HtmlUtils {
	...
	public static void main(String[] args) throws Exception {
		...
		// URL url=new
		// URL("http://47.98.253.246:8080/group1/M00/00/01/rBCh-FsCTASALuABAfJ-APHldC4369.ppt");//默认主页
		// InputStream is=url.openStream();//获取网络流

		/*
		 * //获取网络资源,编码格式不同会出现乱码**************** byte[] flush=new byte[1024]; int len=0;
		 * while(-1!=(len=is.read(flush))) {
		 * 
		 * System.out.println(new String(flush,0,len)); } is.close();
		 * //获取网络资源,编码格式不同会出现乱码
		 *****************/

		// 解决乱码的方法,转换流
		// BufferedReader br=new BufferedReader(new
		// InputStreamReader(url.openStream(),"utf-8"));//解码方式,utf-8
		// String msg=null;
		// BufferedWriter bw=new BufferedWriter(new OutputStreamWriter(new
		// FileOutputStream("e:\\Temp\\1.ppt"),"utf-8"));
...
//		InputStream downloadFile = FastDFSClient.downloadFile("group1/M00/00/00/rBCh-Fr6-iGALkVaAAM0AAEV0Zc776.doc");
		 ...
		 * "D:/poi-test/openOffice/doc","doc"); coc2HtmlUtil.file2pdf(fileInputStream,
		 * "D:/poi-test/openOffice/doc","doc");
		 * 
		 * file = new File("D:/poi-test/周报模版.ppt"); fileInputStream = new
		 * FileInputStream(file); // coc2HtmlUtil.file2Html(fileInputStream,
		 * "D:/poi-test/openOffice/ppt","ppt"); coc2HtmlUtil.file2pdf(fileInputStream,
		 * "D:/poi-test/openOffice/ppt","ppt");
		 * 
		 * file = new File("D:/poi-test/test.docx"); fileInputStream = new
		 * FileInputStream(file); // coc2HtmlUtil.file2Html(fileInputStream,
		 * "D:/poi-test/openOffice/docx","docx"); coc2HtmlUtil.file2pdf(fileInputStream,
		 * "D:/poi-test/openOffice/docx","docx");
		 */
